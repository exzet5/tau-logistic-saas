...
class UserHomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('ניהול ציוד ', style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ...
      body: Center(
        // Allow scrolling for landscape orientation or small devices
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        // Pass companyId to ScannerScreen
